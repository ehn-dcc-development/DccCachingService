...
public class DccCachingService {
    ...
    public init(dateService: DateService? = nil, trustlistUrl : String? = nil, trustlistSignatureUrl: String? = nil, trustlistTrustAnchor: String? = nil, trustlistApiKey: String? = nil, encryptTrustlist: Bool = false,
                businessRulesUrl: String? = nil, businessRulesSignatureUrl: String? = nil, businessRulesTrustAnchor : String? = nil, businessRulesApiKey: String? = nil, encryptBusinessRules: Bool = false,
                valueSetUrl: String? = nil, valueSetSignatureUrl: String? = nil, valueSetTrustAnchor: String? = nil, valueSetApiKey: String? = nil, encryptValueSet: Bool = false){
        self.trustlistService = DefaultTrustlistService(dateService: dateService ?? DefaultDateService(),
                                                        ...
                                                        storeEncrypted: encryptTrustlist)
        ...
        self.businessRulesService = DefaultBusinessRulesService(dateService: dateService ?? DefaultDateService(),
                                                                ...
                                                                storeEncrypted: encryptBusinessRules)
        ...
        self.valueSetService = DefaultValueSetsService(dateService: dateService ?? DefaultDateService(),
                                                       ...
                                                       storeEncrypted: encryptValueSet)
    }
    
    public func initTrustlistService(trustlistUrl : String? = nil, signatureUrl: String? = nil, trustAnchor: String? = nil, apiKey: String? = nil, dateService: DateService? = nil, storeEncrypted: Bool = false) {
        self.trustlistService = DefaultTrustlistService(dateService: dateService ?? DefaultDateService(),
                                                        trustlistUrl: trustlistUrl ?? DccCachingService.DEFAULT_TRUSTLIST_URL,
    ...
    public func initBusinessRuleService(businessRulesUrl: String? = nil, signatureUrl: String? = nil, trustAnchor: String? = nil, apiKey: String? = nil, dateService: DateService? = nil, storeEncrypted: Bool = false) {
        self.businessRulesService = DefaultBusinessRulesService(dateService: dateService ?? DefaultDateService(),
                                                                businessRulesUrl: businessRulesUrl ?? DccCachingService.DEFAULT_BUSINESS_RULES_URL,
    ...
    public func initValueSetService(valueSetUrl: String? = nil, signatureUrl: String? = nil, trustAnchor: String? = nil, apiKey: String? = nil, dateService: DateService? = nil, storeEncrypted: Bool = false) {
        self.valueSetService = DefaultValueSetsService(dateService: dateService ?? DefaultDateService(),
                                                       valueSetsUrl: valueSetUrl ?? DccCachingService.DEFAULT_VALUE_SET_URL,
